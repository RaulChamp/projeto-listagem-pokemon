...
//pode se tirar todos os "console log". limpar o codigo.
//body.classlist.toggle("modo-escuro") ele altera entre dois estados ... reirar 'remove e add' colocar antes do 'if'